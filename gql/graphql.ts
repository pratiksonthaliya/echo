...
export type Query = {
  ...
  getCommentLikes: Array<CommentLike>;
...
export type AddCommentMutation = { __typename?: 'Mutation', addComment: { __typename?: 'Comment', content: string, createdAt: string, id: string, user: { __typename?: 'User', profileImageUrl?: string | null, lastName?: string | null, firstName: string, id: string } } };
...
export type ToggleCommentLikeMutation = { __typename?: 'Mutation', toggleCommentLike: { __typename?: 'CommentLikeResponse', isLiked: boolean, commentLike?: { __typename?: 'CommentLike', id: string, comment: { __typename?: 'Comment', id: string, content: string, createdAt: string }, user: { __typename?: 'User', id: string, firstName: string, lastName?: string | null, email: string, profileImageUrl?: string | null } } | null } };
...
export type GetCommentsByPostQuery = { __typename?: 'Query', getCommentsByPost: Array<{ __typename?: 'Comment', id: string, content: string, createdAt: string, user: { __typename?: 'User', id: string, firstName: string, lastName?: string | null, email: string, profileImageUrl?: string | null } }> };
...
export type GetCommentLikesQuery = { __typename?: 'Query', getCommentLikes: Array<{ __typename?: 'CommentLike', id: string, comment: { __typename?: 'Comment', id: string, content: string, createdAt: string }, user: { __typename?: 'User', id: string, firstName: string, lastName?: string | null, email: string, profileImageUrl?: string | null } }> };
...
export const GetCommentLikesDocument = {"kind":"Document","definitions":[{"kind":"OperationDefinition","operation":"query","name":{"kind":"Name","value":"GetCommentLikes"},"variableDefinitions":[{"kind":"VariableDefinition","variable":{"kind":"Variable","name":{"kind":"Name","value":"commentId"}},"type":{"kind":"NonNullType","type":{"kind":"NamedType","name":{"kind":"Name","value":"ID"}}}}],"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"getCommentLikes"},"arguments":[{"kind":"Argument","name":{"kind":"Name","value":"commentId"},"value":{"kind":"Variable","name":{"kind":"Name","value":"commentId"}}}],"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"id"}},{"kind":"Field","name":{"kind":"Name","value":"comment"},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"id"}},{"kind":"Field","name":{"kind":"Name","value":"content"}},{"kind":"Field","name":{"kind":"Name","value":"createdAt"}}]}},{"kind":"Field","name":{"kind":"Name","value":"user"},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"id"}},{"kind":"Field","name":{"kind":"Name","value":"firstName"}},{"kind":"Field","name":{"kind":"Name","value":"lastName"}},{"kind":"Field","name":{"kind":"Name","value":"email"}},{"kind":"Field","name":{"kind":"Name","value":"profileImageUrl"}}]}}]}}]}}]} as unknown as DocumentNode<GetCommentLikesQuery, GetCommentLikesQueryVariables>;
